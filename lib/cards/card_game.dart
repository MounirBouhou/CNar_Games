  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      //   ),
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row (
                            ...
                            children:[
                              Icon(CupertinoIcons.gamecontroller, size: 14, color: cColors().blueDark,),
                              SizedBox(width: 4),
                              Text(games.views.toString(), style: TextStyle(fontSize: 12, color: Colors.grey.shade200),),
                              SizedBox(width: 15),
                              Icon(CupertinoIcons.heart, size: 14, color: cColors().pinkDark,),
                              SizedBox(width: 4),
                              games.rate!.length <= 1 ?
                              Text((games.rate!) + "/5", style: TextStyle(fontSize: 12, color: Colors.grey.shade200),)
        ...
        onTap: () {
          context.read<NewGamesBloc>().sendViewsCount(heroTag);
